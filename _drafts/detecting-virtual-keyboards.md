...
We need to differentiate between a physical and a virtual keyboard, and browsers currently have no API to do so that I am aware of. [Many](http://stackoverflow.com/questions/2593139/ipad-web-app-detect-virtual-keyboard-using-javascript-in-safari) [people](http://stackoverflow.com/questions/13270659/detect-virtual-keyboard-vs-hardware-keyboard) [are](http://stackoverflow.com/questions/8556933/screen-styling-when-virtual-keyboard-is-active) [asking](http://stackoverflow.com/questions/11600040/jquery-js-html5-change-page-content-when-keyboard-is-visible-on-mobile-devices) for a solution, and some have replied with solutions [measuring window height](http://jsfiddle.net/uhdcw/8/) and various others, but I find these rather unreliable and kludgey. I searched high and low, but could find nothing useful. Then I had a hunch. Does a virtual keyboard care about when you press and release keys the way a physical keyboard, or does it fire `keydown` and `keyup` events instantaneously?
